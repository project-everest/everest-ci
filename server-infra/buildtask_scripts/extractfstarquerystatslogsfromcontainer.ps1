...
docker exec $BuildRequestedAuthor cmd.exe /c type c:\ewerest\log_no_replay.html > log_no_replay.html
docker exec $BuildRequestedAuthor cmd.exe /c type c:\ewerest\log_worst.html > log_worst.html
} else {
